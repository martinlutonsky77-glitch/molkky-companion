...
const SKINS = ['#F5D6BC', '#EFC39C', '#DCA579', '#BE8155', '#96603A', '#6B4426'];
const HAIRS = ['#2E2621', '#5B3B22', '#A9762F', '#D9B26A', '#B9B3AA', '#C9587E'];
const SHIRTS = ['#E76F51', '#4FA6A0', '#6C9BD1', '#8AB17D', '#B08BBB', '#E9C46A', '#D9D2C5', '#EFA6B4'];
...
function renderPortrait(p, opts = {}) {
...
const PARTS = { HEADS, HAIRSTYLES, EYES, BROWS, NOSES, MOUTHS, BEARDS, ACCESSORIES, SKINS, HAIRS, SHIRTS };
...
function portraitDataUri(portrait, opts) {
